    ...
    extends ComplaintDaoBase
{
        ...
        ComplaintVO target)
    {
        ...
        // WARNING! No conversion for target.subject (can't convert source.getSubject():com.googlecode.ouvidoria.model.complaint.Subject to java.lang.String
        // WARNING! No conversion for target.date (can't convert source.getDate():java.util.Date to java.util.Date
        // WARNING! No conversion for target.type (can't convert source.getType():com.googlecode.ouvidoria.model.complaint.ComplaintType to java.lang.String
        // WARNING! No conversion for target.demandant (can't convert source.getDemandant():com.googlecode.ouvidoria.model.demandant.Demandant to com.googlecode.ouvidoria.model.demandant.vo.DemandantVO
    }
