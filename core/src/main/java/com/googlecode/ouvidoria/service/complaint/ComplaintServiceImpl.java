...
public class ComplaintServiceImpl extends ComplaintServiceBase {
	 ...
	 */
	@Override
	protected SimpleComplaintVO handleSave(ComplaintVO vo) throws Exception {
		// TODO implement protected SimpleComplaintVO handleSave(ComplaintVO vo)
		throw new UnsupportedOperationException(
				"com.googlecode.ouvidoria.service.complaint.ComplaintService.handleSave(ComplaintVO vo) Not implemented!");
	}
	...
	protected ComplaintVO handleCheckStatus(Long id, String password)
			throws Exception {
		// TODO implement protected ComplaintVO handleCheckStatus(Long id,
		// String password)
		throw new UnsupportedOperationException(
				"com.googlecode.ouvidoria.service.complaint.ComplaintService.handleCheckStatus(Long id, String password) Not implemented!");
	}
	...
	protected List<ComplaintVO> handleSearch(ComplaintVO criteria)
			throws Exception {
		// TODO implement protected List<ComplaintVO> handleSearch(ComplaintVO
		// criteria)
		throw new UnsupportedOperationException(
				"com.googlecode.ouvidoria.service.complaint.ComplaintService.handleSearch(ComplaintVO criteria) Not implemented!");
	}
