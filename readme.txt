    ...
    that a model called 'ouvidoria' has been created within your Magic Draw model.
    
    Important: before launching AndroMDA, be sure to have exported your model.

    /ouvidoria J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (Windows)
        C:\Documents and Settings\Pedro Costa\.m2\repository\ouvidoria\

        (*nix)
        /home/Pedro Costa/.maven/repository/ouvidoria/
