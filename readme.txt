    ...
    The project located in this directory has been generated by Pedro Costa
    using the andromdapp:generate Maven plugin.

    You should at least be running Maven 2.0.8 if you want to build your
    ...
    that a model called 'siscoe-negocio' has been created within your Magic Draw model.

    Important: before launching AndroMDA, be sure to have exported your model.

    /siscoe-negocio J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (*nix)
        /home/Pedro Costa/.m2/repository/siscoe-negocio/
...
#############################################
mvn -Dandromda.run.skip install  
mvn dependency:tree
mvn dependency:analyze
mvn site
mvn findbugs:gui

Exemplo pra rodar os testes do siscoe-negocio:
mvn -f core/pom.xml test

* Para nao executar testes:
